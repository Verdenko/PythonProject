...
class IrenderWoodcatalog(Base):
    ...
    wood_type_id = Column(ForeignKey('irender_woodtype.id', deferrable=True, initially='DEFERRED'), nullable=False, index=True)
...
class IrenderWoodparameter(Base):
    ...
    dryer_id = Column(ForeignKey('irender_dryertype.id', deferrable=True, initially='DEFERRED'), nullable=False, index=True)
    period_id = Column(ForeignKey('irender_timeperiod.id', deferrable=True, initially='DEFERRED'), nullable=False, index=True)
    wood_type_id = Column(ForeignKey('irender_woodtype.id', deferrable=True, initially='DEFERRED'), nullable=False, index=True)
